        ...
        <section className="sign">
            ...
            <form className="sign__form" action="POST">
                <label className="sign__field">
                    ...
                    <input className="sign__input sign__input_type_named" id="named" type="text" name="name" autoComplete="off" required />
            ...
            <div className="sign__caption">
                ...
                <NavLink className="sign__caption-link" to="/signin">Войти</NavLink>
            </div>
        </section>
    </main>
  );
